    ...
    public partial class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        void Makestage1()
        {
            ...
            if (flg1 == 1)
            {
                ...
                {
                    makeEnemy(new Vector2(0, 100),0, 1,5,3);
                    flg2++;
                }
            ...
            if (flg1 == 4)
            {
                if (flg2 == flg1 - 1)
                {
                    if (sw2.IsRunning)
                    {
                        ...
                        if (flg3 - flg4 == 1)
                        {
                            makeEnemy(ichi, 0, 2, 3, 2);
                            makeEnemy(new Vector2(-50, 100), 0, 1, 3, 2);
                            ichi += ichikankakaku;
                            kazu--;
                            flg4++;
                        }
            ...
            if (flg1 == 5)
            {
                if (flg2 == flg1 - 1)
                {
                    if (sw2.IsRunning)
                    {
                        ...
                        if (flg3 - flg4 == 1)
                        {
                            makeEnemy(ichi, 0, 5, 4, 3);
                            makeEnemy(new Vector2(600, 0), 0, 5, 4, 3);
                            ichi += ichikankakaku;
                            kazu--;
                            flg4++;
                        }
            ...
            if (flg1 == 6)
            {
                if (flg2 == flg1 - 1)
                {
                    if (sw2.IsRunning)
                    {
                        ...
                        if (flg3 - flg4 == 1)
                        {
                            makeEnemy(new Vector2(0, 100), 2, 1, 1, 5);
                            makeEnemy(new Vector2(800, 100), 2, 2, 1, 5);
                            makeEnemy(ichi, 1, 7, 4, 4);
                            ichi += ichikankakaku;
                            kazu--;
                            flg4++;
                        }
                ...
                if (flg2 == flg1 - 1)
                {
                    if (sw2.IsRunning)
                    {
                        ...
                        if (flg3 - flg4 == 1)
                        {
                            ...
                            while (temp > 0)
                            {
                                makeEnemy((ichi + ichikankakaku * (doujiPop - temp)), 0, 4, 6, 1);
                                temp--;
                            }
                            kazu--;
                            flg4++;
                ...
                if (flg2 == flg1 - 1)
                {
                    if (sw2.IsRunning)
                    {
                        ...
                        if (flg3 - flg4 == 1)
                        {
                            ...
                            while (temp > 0)
                            {
                                makeEnemy((ichi + ichikankakaku * (doujiPop - temp)), 0, 3, 6, 1);
                                temp--;
                            }
                            kazu--;
                            flg4++;
